...
def main():
    ...
    for slot in TARGETS:
        ...
        for name in configured_meshes:
            ...
            rigid_bone = replacement_rules.get("temporary_rigid_bone")
        ...
        if replacement_rules.get("disable_face_deformation", False):
            for kind in (0xB00A, 0xB00B):
            ...
            print(f"slot {slot}: disabled original B00A/B00B facial deformation")
