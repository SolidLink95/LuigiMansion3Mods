...
def main() -> int:
    try:
        ...
        builder.OUTPUT = PACKAGE_DIR / "N64_green_knight_playable" / "romfs"
    ...
    print("created N64_green_knight_playable in " + str((PACKAGE_DIR / "N64_green_knight_playable" / "romfs").resolve()))
    return 0
