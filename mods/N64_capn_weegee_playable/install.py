...
def main() -> int:
    try:
        ...
        builder.OUTPUT = PACKAGE_DIR / "N64_capn_weegee_playable" / "romfs"
    ...
    print("created N64_capn_weegee_playable in " + str((PACKAGE_DIR / "N64_capn_weegee_playable" / "romfs").resolve()))
    return 0
