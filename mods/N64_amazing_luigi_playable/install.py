...
def main() -> int:
    try:
        ...
        builder.OUTPUT = PACKAGE_DIR / "N64_amazing_luigi_playable" / "romfs"
    ...
    print("created N64_amazing_luigi_playable in " + str((PACKAGE_DIR / "N64_amazing_luigi_playable" / "romfs").resolve()))
    return 0
